...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Pratham</span> Rai
                <br />Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (NEXT.JS or SvelteKit or Reactjs or Vuejs), TailwindCSS, Node.js + Express.js & PostgreSQL
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <a
            href="https://github.com/pratham5368"
            target="_blank"
    ...
    >
        ...
        >
            <table class="bg-white text-slate-700 text-center rounded-lg">
        ...
        <p class="mx-auto">So why not get on touch?</p>
